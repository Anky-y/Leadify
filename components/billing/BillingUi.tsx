...
import { AlertCircle, CheckCircle, CreditCard, Receipt } from "lucide-react";
                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className="text-sm">
                      127 {!user?.is_subscribed && "/ Unlimited"}
                    </span>
                  </div>
