...
export function DiscordLogo(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M15 11a1 1 0 1 0 2 0 1 1 0 0 0-2 0z" />
      <path d="M7.5 4h9c.5 0 1.5 0 2 1l1 4c1 4 1 8 0 12-3 1-6 1-9 0-3 1-6 1-9 0-1-4-1-8 0-12l1-4c.5-1 1.5-1 2-1z" />
      <path d="M8 22c4 0 4-3 4-3" />
      <path d="M16 22c-4 0-4-3-4-3" />
    </svg>
  )
}
...
export function EnvelopeSimple(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
