  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Streamers Found</CardTitle>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium">English Fortnite Streamers</p>
                  <p className="text-xs text-muted-foreground">2 hours ago</p>
                </div>
                <Link href="/dashboard/twitch-scraper" className="text-blue-600 hover:text-blue-800">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium">Tech Reviewers 10k+ Followers</p>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <p className="text-sm">{user.subscribed ? "Premium" : "Free"}</p>
              </div>
              <div className="flex items-center justify-between">
                <p className="text-sm font-medium">Search Limit</p>
                <p className="text-sm">{user.subscribed ? "Unlimited" : "10 results per search"}</p>
              </div>
              <div className="flex items-center justify-between">
                <p className="text-sm font-medium">Export Limit</p>
                <p className="text-sm">{user.subscribed ? "Unlimited" : "100 per month"}</p>
              </div>
              <div className="flex items-center justify-between">
                <p className="text-sm font-medium">Saved Searches</p>
                <p className="text-sm">{user.subscribed ? "Unlimited" : "5 max"}</p>
              </div>
              {!user.subscribed && (
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Most popular categories in your searches.</CardDescription>
          </CardHeader>
          <CardContent className="h-[220px] flex items-center justify-center">
            <div className="text-muted-foreground text-sm">Chart placeholder - would show category distribution</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
            <CardTitle>Language Distribution</CardTitle>
            <CardDescription>Languages of streamers in your searches.</CardDescription>
          </CardHeader>
          <CardContent className="h-[220px] flex items-center justify-center">
            <div className="text-muted-foreground text-sm">Chart placeholder - would show language distribution</div>
          </CardContent>
        </Card>
      </div>
    </div>
